...
// *****************************************************************************
    ...
    public function showhelp() {
        ...
        $str = <<<EOF
               ...
               macd4.php -f[fastPeriod] -s[slowPeriodl] -S[signalPeriod] -p[pairname] -c[BTC investment] -x[xsteps] -d(ebug) -h(elp)
...
// *****************************************************************************
    ...
    public function getARopts(&$cvars) {
        $xr = $this->getoptreq('f:s:S:p:m:c:x:U:D:X:z:d:h', array('fastperiod:', 'slowperiod:', 'signalperiod:', 'pairq:', 'btcinv:', 'xsteps:', 'minpctup:', 'maxpctdn:', 'method:', 'data:', 'debug:', 'help'));
